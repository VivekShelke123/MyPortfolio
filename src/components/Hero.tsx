...
const Hero = () => {
    return (
        <div>
            ...
            <div className="h-screen w-full  bg-black-100  bg-grid-white/[0.03] absolute flex items-center justify-center left-0 top-0">
            ...
            <div className="flex justify-center relative my-10 z-10">
                ...
                words="Hi I'm Vivek Shelke A Passionate Web Devloper"
                />
                </div>
            </div>
